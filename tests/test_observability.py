...
# send-weighted means come out to round numbers the tests can pin: rtt mean = (12.5*40 + 10.0*60)/100 =
# 11.0; took mean = (8.0*40 + 6.0*60)/100 = 6.8; docs/send = 1_000_000/100 = 10000.0.
_BULK_STATS = [
    {"n_sends": 40, "docs_sent": 400000,
